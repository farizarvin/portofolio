        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
          <div className="flex flex-col gap-4 flex-1">
            ...
            <p className="text-muted-foreground max-w-sm opacity-70">
              Full-stack developer creating beautiful web experiences with modern technologies.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8 md:gap-12">
            <div className="flex flex-col gap-3">
              <h3 className="text-sm font-medium tracking-tight">Navigation</h3>
            ...
            <div className="flex flex-col gap-3">
              <h3 className="text-sm font-medium tracking-tight">Connect</h3>
              <ul className="flex flex-col gap-2">
                <li>
                  <Link
                    href="#contact"
