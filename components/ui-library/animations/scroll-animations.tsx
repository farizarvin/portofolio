...
import { motion, useAnimation, useScroll, useTransform, type Variant, type Easing } from "framer-motion"
...
export function ScrollAnimation({
  ...
  const getVariants = () => {
    ...
    if (type === "fade" || type === "slide") {
      variants.hidden = { ...variants.hidden, opacity: 0 }
    ...
    if (type === "rotate") {
      variants.hidden = { ...variants.hidden, rotate: direction === "left" ? -90 : 90 }
      variants.visible = { ...variants.visible, rotate: 0 }
    }

    // Handle flip animation
    if (type === "flip") {
      if (direction === "up" || direction === "down") {
        variants.hidden = { ...variants.hidden, rotateX: direction === "down" ? 90 : -90 }
        variants.visible = { ...variants.visible, rotateX: 0 }
      } else {
        variants.hidden = { ...variants.hidden, rotateY: direction === "right" ? 90 : -90 }
